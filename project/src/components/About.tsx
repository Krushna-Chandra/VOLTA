        ...
        <div className={`max-w-6xl mx-auto mb-20 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                Our state-of-the-art manufacturing facility combines traditional craftsmanship with cutting-edge automation, ensuring every vehicle meets the highest standards of quality and performance.
              </p>
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className={`${index % 2 === 0 ? 'lg:text-right' : 'lg:text-left lg:col-start-2'}`}>
                    <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              <div key={index} className="text-center group">
                <div className="bg-slate-50 dark:bg-slate-900 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
